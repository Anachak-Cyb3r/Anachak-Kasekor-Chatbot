"""
Anachak Kasekor Chatbot - Replit Version
This version includes keep_alive for 24/7 hosting on Replit
"""
    ...
    if language == 'khmer':
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("🛒 ទីផ្សារ", url=f"https://t.me/{MARKET_BOT}"),
             InlineKeyboardButton("💬 ទីព្រឹក្សាកសិកម្ម", url=f"https://t.me/{CHATBOT}")],
...
def main():
    ...
    if REPLIT_MODE:
        print("🌐 Starting keep-alive server for Replit...")
        keep_alive()
    ...
    if REPLIT_MODE:
        print("✅ Replit mode: Keep-alive server is active")
        print("📌 Add your Replit URL to UptimeRobot for 24/7 uptime")
